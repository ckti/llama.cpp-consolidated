...
function(ggml_cuda_fattn_vec_instances DIR OUT_SRCS)
    ...
    list(APPEND FA_COMBINATIONS f16-q8_0 q8_0-f16 bf16-q8_0 q8_0-bf16)
    foreach (TYPE_V f16 q8_0 turbo2_0 turbo3_0 turbo4_0)
        foreach (TYPE_K f16 q8_0 turbo2_0 turbo3_0 turbo4_0)
            if (TYPE_K MATCHES "^turbo" OR TYPE_V MATCHES "^turbo")
                list(APPEND FA_COMBINATIONS ${TYPE_K}-${TYPE_V})
            endif()
        endforeach()
    endforeach()
