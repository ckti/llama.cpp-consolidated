...
// TurboQuant K/V blocks. The generic FA shader exposes turbo2/3/4 aliases
// selected by FaTypeK/FaTypeV. DATA_A_TURBO3_0 keeps only turbo3 bindings to
// avoid aliased SSBO stride collisions on drivers that are sensitive to them.
#if !defined(DATA_A_TURBO3_0)
